...
import com.example.kelas2.ui.theme.Kelas2Theme
        ...
        setContent {
            Kelas2Theme {
                ...
                Surface(
                    ...
                    TampilLayar(pesan = getString(R.string.greet), dari = getString(R.string.frm))
                }
            }
        }
    }
...
fun GreetingPreview() {
    Kelas2Theme {
        TampilLayar(pesan = "Halo Semuanya", dari = "Yogyakarta")
    }
}